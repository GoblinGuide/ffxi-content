--todo: update sets
--todo: hardcode a toggle for af hands for learning things
...
function user_setup()
	...
	--think I only want the one cape, null shawl can handle the engaged set
	gear.AmbuCape = {}
    ...
    gear.AFHands = {name="Assimilator's Bazubands +1"} --BLUE MAGIC LEARNING CHANCE UP (make a toggle I think)
...
function init_gear_sets()
    ...
    sets.midcast['Blue Magic'] = {
		...
		feet=gear.EmpyFeet,
        neck="Sibyl Scarf",
		--waist="Sacro Cord", --8 mab 8 macc 8 int/mnd --wear something that exists
    ...
    sets.midcast['Blue Magic'].PhysicalInt = set_combine(sets.midcast['Blue Magic'].Physical, {
		...
		--waist="Sacro Cord", --replace this if I care
    ...
    sets.midcast['Blue Magic']['Cruel Joke'] = set_combine(sets.midcast['Blue Magic'], {
		...
		--neck="Incanter's Torque", --10 blue skill = 10 macc
    ...
    --also 1 refresh from null masque which will make einherjar botting functional
    ...
    sets.idle = {
		...
		neck="Null Loop", --5 dt (46) --this is the one job I actually use this for DT on. sorry warder's charm +1
		...
		right_ring="Shadow Ring" --magic absorb etc
    ...
    --46 dt, close enough, all fake content anyway
    sets.engaged = {
        ammo="Coiste Bodhar",
        ...
        feet="Malignance Boots", --4 dt
        --neck="Combatant's Torque", --wardrobe 3 forever because rdm --no clue what actually goes here that I will care enough to have but I'm gonna make this eventually, so I guess this?
		waist="Reiki Yotai", --dw
        left_ear="Alabaster Earring", --5 dt
        right_ear="Eabani Earring", --dw
        left_ring="Epona's Ring", --Petrov might be better but this job's on the full item reuse plan
