--todo: make sure one of the paeons has a specific set to have daurdabla and is labelled as the dummy song (there's gotta be a better way than this macro, just hardcode one, etc)
...
--[[
    ...
    --TODO: FIGURE OUT ALL THIS OUT EVENTUALLY
...
function init_gear_sets()
    ...
    gear.AFLegs = {name="Brioso Cannions +3"} --UNUSED (legs have song duration and it's total of -13 macc to use regal instead of this+macc ear, not worth it)
    ...
    gear.RelicBody = {name="Bihu Justaucorps +4"} --troubadour duration, wsd
    gear.RelicHands = {name="Bard's Cuffs"} --UNUSED
    gear.RelicLegs = {name="Bihu Cannions +3"} --soul voice duration
    gear.RelicFeet = {name="Bihu Slippers +4"} --nightingale duration, string skill for lullaby
