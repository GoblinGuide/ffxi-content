...
function init_gear_sets()
    ...
    --if I'm using this I actually want to do damage and also default... well, actually no.
    ...
    body="Nyame Mail", --no TH
    hands="Nyame Gauntlets", --no TH
    legs="Nyame Flanchard",
    feet="Nyame Sollerets",
    ...
    back="Null Shawl", --this is fine whatever
    })
    ...
    sets.engaged = {
        ...
        neck="Combatant's Torque", --whatver
		waist="Reiki Yotai", --this shouldn't be this but also I do not care. at all.
        left_ear="Alabaster Earring", --dt cappedish?
	...
	feet="Nyame Sollerets",
	neck="Warder's Charm +1", --whatever
